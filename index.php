...
<section class="top-home myhome">
    ...
    <div class="col-lg-6 height-dog">
        ...
        <p class="for-anim-2"><span>Design Dok is a digital design agency specializing in branding,  </span><span>animation, mobile and web design and development.</span></p>
        ...
        <div class="app-container"> 
            ...
            <div class="tab-custom">
                <ul class="tabbing-links">
                  <!--<li data-targetit="tabs-all">All</li>-->
                  <li class="current" data-targetit="tabs-webdesign">Web Design</li>
                ...
                <div class="tabs tabs-webdesign current row m-app-slider no-gutters for-works-load loadmoreweb">
                    <?php
                ...
                <div class="tabs tabs-logodesign row m-app-slider no-gutters for-works-load loadmorelogo">
                    ...
                    ?>
                     ...
                     <div class="tabs tabs-branding row m-app-slider no-gutters for-works-load loadmorebranding">
                    <?php
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="hover-block">
                                            <a href="<?php echo $path;?>logo-design">
                                                <i class="motion">
            ...
            c-11.261,0.054-20.812,9.45-21.008,20.668C933.336,544.328,943.08,554.01,954.873,553.897z"/>
                            ...
                            <div class="col">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="hover-block">
                                            <a href="<?php echo $path;?>website-design-development">
                                                <i class="web">
                ...
                <span>Web</span>
                            ...
                            <div class="col">
                                ...
                                <div class="col-12">
                                    <div class="hover-block">
                                        <a href="<?php echo $path;?>mobile-apps">
                                            <i class="mobile-apps">
                        ...
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <div class="col">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="hover-block">
                                            <a href="<?php echo $path;?>motion-graphics">
                                                <i class="motion">
